...
namespace TeslaKey.Languages
{
    ...
    public class TextBaseNL : TextBase
    {
        ...
        public override string infotext => @"Deze site slaat geen gegevens van u op, en is gratis voor gebruik.<br />Het C#-Project kan op <a href=&quote;&quote;>GIT</a> gevonden worden, onder een  <a href=&quote;&quote;>...</a> licentie.<br />";
    ...
    public class TextBaseEN : TextBase
    {
        ...
        public override string infoheader => "Disclaimer ©2020";
        public override string infotext => @"This site doesn't save your credentials, and is free for use.<br />The C#-Project can be found on <a href=&quote;&quote;>GIT</a>, under a  <a href=&quote;&quote;>...</a> license.<br />";
    }
}
